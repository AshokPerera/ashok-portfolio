            ...
            <RevealOnScroll>
                <div className="text-center z-10 px-4">
                    ...
                    <p className="tex-gray-400 text-lg mb-8 max-w-lg mx-auto">
                        I'm a Software Engineer who thrives on building scalable,
                        high-performing applications. I care deeply about clean code,
                        intuitive user experiences, and bringing ideas to life in
